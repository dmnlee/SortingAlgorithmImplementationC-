...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(68, 85);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(244, 85);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(155, 109);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(155, 51);
			...
			this->ClientSize = System::Drawing::Size(406, 154);
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) { // MERGE button
	...
	this->label1->Text = Convert::ToString(mergeSort[0]);
	this->label2->Text = Convert::ToString(mergeSort[1]);
	this->label3->Text = Convert::ToString(mergeSort[2]);

	this->button1->Enabled = true; //after button press, button is disabled
